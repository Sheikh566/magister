...
* **Build Your Own DNS Server** (`dns-server`)
  * Start with UDP datagrams and progressively implement DNS headers, questions, answers, forwarding, recursive resolution, TTL caching, IPv6 records, and TCP fallback.
